...
class MocoModel(pl.LightningModule):
    def __init__(self, backbone, feature_dim=512, projection_dim=128, temperature=0.07):
        ...
        self.projection_head = MoCoProjectionHead(feature_dim, projection_dim, projection_dim)
        ...
        self.key_projection_head = MoCoProjectionHead(feature_dim, projection_dim, projection_dim)

...
# Fixed parameters
path_to_train = "/home/legacy/data/cifar10/train"
batch_size = 128
num_workers = 8
seed = 1
max_epochs = 100
...
def main():
    ...
    transform = MoCoV2Transform(input_size=32, gaussian_blur=0.0)
    ...
    trainer = pl.Trainer(
        ...
        accelerator="gpu",
        logger=logger,
        precision="16-mixed",  # Corrected the precision setting
    )
